...
def create_model(
    ...
    if pretrained == "openai":
        ...
        if pretrained:
            if 'data/checkpoints' in pretrained and 'AudioLDMControlNetInfer/ModelWeight/' not in pretrained:
                pretrained_orig = pretrained_orig.replace('data/checkpoints','./AudioLDMControlNetInfer/ModelWeight/')
            checkpoint_path = ""
