...
from Model.AudioLdm.audioldm_train.conditional_models import *
import datetime

from Model.AudioLdm.audioldm_train.utilities.model_util import (
    exists,
    default,
    mean_flat,
    count_params,
...
from Model.AudioLdm.audioldm_train.modules.diffusionmodules.ema import LitEma
from Model.AudioLdm.audioldm_train.modules.diffusionmodules.distributions import (
    normal_kl,
...
from Model.AudioLdm.audioldm_train.modules.latent_diffusion.plms import PLMSSampler
...
class DDPM(pl.LightningModule):
    ...
    def __init__(
        ...
        self.clap = CLAPAudioEmbeddingClassifierFreev2(
            pretrained_path="./AudioLDMControlNetInfer/ModelWeight/clap_music_speech_audioset_epoch_15_esc_89.98.pt",
...
class LatentDiffusion(DDPM):
    ...
    def get_waveform_list(self, waveform) -> list:
        waveform_list = list()
        for i in range(waveform.shape[0]):
            todo_waveform = waveform[i, 0]
            todo_waveform = (
            ...
            waveform_list.append(todo_waveform)
