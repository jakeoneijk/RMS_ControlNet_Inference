...
def instantiate_from_config(config):
    ...
    param_dict = config.get("params", dict())
    if 'reload_from_ckpt' in param_dict:
        param_dict['reload_from_ckpt'] = './AudioLDMControlNetInfer/ModelWeight/vae_mel_16k_64bins.ckpt'
    return get_obj_from_str(config["target"])(**param_dict)
...
def get_vocoder(config, device, mel_bins):
    ROOT = "./AudioLDMControlNetInfer/ModelWeight"
